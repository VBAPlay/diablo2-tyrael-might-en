...
***Regarding MF for Summon & [Hireling](https://diablo2-vn.com/hireling/), it will stack with your MF and that of your hireling (follower) for hirelings, and with your MF for summons.

![MF](https://i0.wp.com/tm.diablo2-vn.com/app/uploads/2022/06/mf-300x254.png?resize=300%2C254&ssl=1)

![MFF](https://i0.wp.com/tm.diablo2-vn.com/app/uploads/2022/06/MFF-1-300x232.png?resize=483%2C373&ssl=1)
...
* Andariel (Nightmare and Hell): The best for running Stone of Jordan (Nightmare). In Hell, she has the highest chance to drop Gul.
* Council (Hell): Among the 3 unique monsters, easy to defeat, run quickly, and drop decent runes.
* Mephisto (Hell): The easiest boss to kill, not too strong, low HP, and sorcerers can use the moat trick to trap him, details will be explained later.* Pindleskin (Hell): This boss is quite easy, slow, and easy to kill. It only takes 20-30 seconds for a run. You can do more than 100 runs in an hour. Pindleskin is located in the nik temple, where Q4 is done. Note that in order to run this boss, DO NOT DO Q4 because once you finish or take the waypoint, the red portal will disappear—>no more runs

* Baal (Nightmare and Hell): Of course, this boss has the best drop rate in the game but encountering it can take quite a while, almost 6 minutes for each run.

* Countess: The rune drops are very good, and if you have high Magic Find (MF), Countess can also drop some valuable items. Below is a small table showing the rune drop probabilities when running Countess:
  * Lo – 0.000312%
  * Ohm – 0.000468%
  * Vex – 0.000546%
  * Gul – 0.000819%
...
* Chaos Sanctuary is another good place for runs, but you may need a hammerdin build to be able to run it as the monsters there are tough, deal various elemental damage, and have curses, especially Iron Maiden and Amplify Damage.

### Rune Finding <a href="#rune-finding" id="rune-finding"></a>

#### Overview of Runes <a href="#so-luoc-ve-rune" id="so-luoc-ve-rune"></a>

A rune is a special type of item in Diablo II. It is similar to gems and jewels but the key difference is that runes can create unique items with special properties by combining the right rune with the right item. It's important to note that the rune drop chance is not influenced by a character's Magic Find (MF) but only by the mob's mlvl (monster level). Specifically:
...
The number in brackets applies to melee mobs. This means that a melee mob with mlvl 75 is required to drop a Ber rune. The more players in a game, the higher the chance to drop runes. When rune hunting, always remember: the more high-level mobs you kill, the better. All high-level mobs are equally valuable, and if you kill them all, the rune drop chance will be higher. The next section covers different strategies for rune hunting.#### The Countess 
...
* FireSor: Mep, Andariel (very fast), Andariel has -50 fire resistance, excellent for firesor
* LightSor: Pin, Shrek, Edrick, various super uniques, many minions, low health (if equipped with Infinity, still great for running chaos sanc)
* Winddruid: from spider forest to lower kuzard, mobs here are numerous but have low health, perfect for wind